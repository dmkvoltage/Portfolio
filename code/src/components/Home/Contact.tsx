      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="mt-12 md:mt-0 p-6 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg text-white">
              <div className="flex items-center mb-4">
                <MessageSquare size={24} className="mr-2" />
                <h3 className="text-xl font-bold">Chat Directly</h3>
              </div>
              <p className="mb-4 text-white/90">
                Need a quick response? Chat with me directly on social media.
              </p>
              <Button
                variant="outline"
